...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "BY": t.kind = 47; break;
			case "LOOP": t.kind = 48; break;
			case "WITH": t.kind = 49; break;
			case "EXIT": t.kind = 50; break;
			case "RETURN": t.kind = 51; break;
			case "NIL": t.kind = 55; break;
			case "IS": t.kind = 64; break;
			case "OR": t.kind = 65; break;
			case "DIV": t.kind = 68; break;
			case "MOD": t.kind = 69; break;
			default: break;
		}
	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 8:
				{t.kind = 4; break;}
			case 9:
				if (ch <= 9 || ch >= 11 && ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); goto case 9;}
				else if (ch == '"') {AddCh(); goto case 11;}
				else {goto case 0;}
			case 10:
				if (ch <= 9 || ch >= 11 && ch <= '&' || ch >= '(' && ch <= 65535) {AddCh(); goto case 10;}
			...
			case 12:
				...
				else if (ch >= 'A' && ch <= 'F') {AddCh(); goto case 13;}
				else if (ch == '.') {apx++; AddCh(); goto case 14;}
				else if (ch == 'H' || ch == 'L') {AddCh(); goto case 3;}
				else if (ch == 'X') {AddCh(); goto case 8;}
				else {t.kind = 2; break;}
			case 13:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F') {AddCh(); goto case 13;}
				else if (ch == 'H' || ch == 'L') {AddCh(); goto case 3;}
				else if (ch == 'X') {AddCh(); goto case 8;}
				else {goto case 0;}
			case 14:
