...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 49; i <= 57; ++i) start[i] = 14;
		start[48] = 15; 
		start[34] = 12; 
		start[59] = 19; 
		start[46] = 41; 
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "BY": t.kind = 48; break;
			case "LOOP": t.kind = 49; break;
			case "WITH": t.kind = 50; break;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 7:
				...
				else if (ch >= 'D' && ch <= 'E') {AddCh(); goto case 8;}
				else {t.kind = 3; break;}
			case 8:
			...
			case 11:
				{t.kind = 4; break;}
			case 12:
				if (ch <= 9 || ch >= 11 && ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); goto case 12;}
			...
			case 14:
				...
				else if (ch >= 'A' && ch <= 'F') {AddCh(); goto case 16;}
				else if (ch == 39) {AddCh(); goto case 17;}
				else if (ch == 'H') {AddCh(); goto case 6;}
